...
cors_headers_exempt_urls = ["http://localhost:5050", "http://localhost:3000"]
cors_urls = ["http://localhost:3000","http://localhost:5050","https://cancer-beacon-demo.ega-archive.org", "https://beacon-network-demo2.ega-archive.org", "https://beacon.ega-archive.org"]
